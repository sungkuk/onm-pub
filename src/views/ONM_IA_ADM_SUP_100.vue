  ...
  <section class="onmContent">
    ...
    <div class="flex-row">
      ...
      <div class="col-lg-6 col-md-12">
        ...
        <div class="table">
          <table>
            <caption class="sr-only">배치 기본정보</caption>
            <colgroup>
              <col width="20%">
              <col width="30%">
              <col width="20%">
            ...
            <tbody>
              <tr>
                ...
                <td><input type="text" class="form-control" placeholder="배치명"></td>
              </tr>
              <tr>
                ...
                <td> <input type="text" class="form-control" placeholder="배치파일명"></td>
              </tr>
              <tr>
                <th scope="row"><span>배치시간</span></th>
                <td><input type="text" class="form-control" placeholder="배치시간"></td>
                <th scope="row"><span>최종수정일시</span></th>
                <td><input type="text" class="form-control" placeholder="배치시간"></td>
              </tr>
              <tr>
                <th scope="row"><span>배치파일경로</span></th>
                <td colspan="3"><input type="text" class="form-control" placeholder="배치파일경로"></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="col-lg-6 col-md-12 subject">
        ...
        <div class="table">
          <table>
            <caption class="sr-only">배치파일 최종 업데이트일</caption>
            <colgroup>
              <col width="30%">
              <col width="*">
            </colgroup>
            <tbody>
              <tr>
                <th scope="row" class="required"><span>배치파일 최종업데트일</span></th>
                <td>
                  <div class="col-lg-5">
                    <date-picker />
                  </div>
        ...
        <p class="infoText">※ 배치파일을 수정한 경우 업데이트일을 위에서 선택해 주세요.</p>
        <sub-title class="mt-20" title="비고" />
        <div class="defaultBox" style="height: 75px;">
          비고내용
        </div>
      </div>
    </div>
